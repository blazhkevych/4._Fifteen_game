    ...
    public class FifteenPresenter
    {
        ...
        private void CountingButtonsInTheirPlacesasPercentage(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                for (int j = 0; j < 4; j++)
                {
                    if (i == 0 && j == 0 && _model[0, 0] == 1)
                    {
                        count++;
                    }

                    if (i == 0 && j == 1 && _model[0, 1] == 2)
                    {
                        count++;
                    }

                    if (i == 0 && j == 2 && _model[0, 2] == 3)
                    {
                        count++;
                    }

                    if (i == 0 && j == 3 && _model[0, 3] == 4)
                    {
                        count++;
                    }

                    if (i == 1 && j == 0 && _model[1, 0] == 5)
                    {
                        count++;
                    }

                    if (i == 1 && j == 1 && _model[1, 1] == 6)
                    {
                        count++;
                    }

                    if (i == 1 && j == 2 && _model[1, 2] == 7)
                    {
                        count++;
                    }

                    if (i == 1 && j == 3 && _model[1, 3] == 8)
                    {
                        count++;
                    }

                    if (i == 2 && j == 0 && _model[2, 0] == 9)
                    {
                        count++;
                    }

                    if (i == 2 && j == 1 && _model[2, 1] == 10)
                    {
                        count++;
                    }

                    if (i == 2 && j == 2 && _model[2, 2] == 11)
                    {
                        count++;
                    }

                    if (i == 2 && j == 3 && _model[2, 3] == 12)
                    {
                        count++;
                    }

                    if (i == 3 && j == 0 && _model[3, 0] == 13)
                    {
                        count++;
                    }

                    if (i == 3 && j == 1 && _model[3, 1] == 14)
                    {
                        count++;
                    }

                    if (i == 3 && j == 2 && _model[3, 2] == 15)
                    {
                        count++;
                    }

                    if (i == 3 && j == 3 && _model[3, 3] == 0)
                    {
                        count++;
                    }
                }
            ...
            if (count == 16)
            {
                ...
                TimeSpan timeSpan = _model.GameStopTime - _model.GameStartTime;
